...
const Button = ({ variant, color, label, onClick }: ButtonProps) => {
  return (
    <MuiButton
      variant={variant}
      color={color}
      ...
      >
        ...
        <Grid item sx={{ paddingTop: 2 }} xs={6} md={12}>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            <div></div>
            <div style={{ padding: 3 }}>
              <Button variant="contained" color="error" label="reset" />
              <Button variant="contained" color="primary" label="save" />
            </div>
          </Box>
        </Grid>
      </Grid>
